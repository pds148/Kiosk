...
public class ForzenCustard extends Menu {
    ...
    public ForzenCustard(int menuId, String menuName, String menuDescription,int price, ShakeShackPatty.PattyType pattyType) {
